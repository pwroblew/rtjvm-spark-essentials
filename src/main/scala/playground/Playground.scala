...
/** This is a small application that loads some manually inserted rows into a Spark DataFrame. Feel
  * free to modify this code as you see fit, fiddle with the code and play with your own exercises,
  * ideas and datasets.
  *
  * Daniel @ Rock the JVM
  */
object Playground {
  ...
  def main(args: Array[String]): Unit = {
    ...
    /** The two lines below create an RDD of rows (think of an RDD like a parallel collection). Then
    ...
    /** If the schema and the contents of the DataFrame are printed correctly to the console, this
      * means the libraries work correctly and you can jump into the course!
      */
    carsDF.printSchema()
    carsDF.show()
  }
