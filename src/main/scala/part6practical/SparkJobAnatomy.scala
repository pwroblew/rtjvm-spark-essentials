...
object SparkJobAnatomy {
  ...
  /** This is the code we wrote during the Spark Job Anatomy lecture. We tested these RDDs,
    * DataFrames and Datasets in the Spark shell in the cluster.
    *
    * This code is not meant to be run standalone (although of course you could). It was mostly used
    * to deconstruct Spark jobs and exemplify stages, tasks and the DAG.
    *
    * We will keep the code here for posterity so you can reference it later. You can copy these
    * expressions and paste them (even multi-line) into the Spark shell.
    */
  ...
  def main(args: Array[String]): Unit = {
    ...
    /** Complex job 1 This executes two JOBS! The Spark optimizer is able to pre-determine the
      * job/stage/task planning before running any code.
      */
    ...
    /** Complex job 2 This executes a single job with a massive DAG, and 6 stages:
